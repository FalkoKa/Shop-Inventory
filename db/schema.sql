...
INSERT INTO categories (category, category_description) VALUES ('Shoes', 'Shoes can be defined as an outer covering for the human foot typically having a thick or stiff sole with an attached heel and an upper part of lighter material (such as leather)');
INSERT INTO categories (category, category_description) VALUES ('Shirts', 'Shirts can be defined as a garment for the upper part of the body usually with a collar, sleeves, a front opening, and a tail long enough to be tucked inside pants or a skirt.');
